const SobreNosotros = () => {
    return (
      <div className="sobre-nosotros">
        ...
        <p>Bienvenido a la Aplicación de Lista de Tareas</p>
        <p>Esta aplicación es una herramienta simple y eficiente para ayudarte a administrar tus tareas diarias de manera efectiva.</p>
        <p>Características clave:</p>
        <ul>
          <li>Crea nuevas tareas con nombres descriptivos y, opcionalmente, añade una descripción detallada.</li>
          <li>Marca las tareas como completadas a medida que las finalizas.</li>
